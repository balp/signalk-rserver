...
use signalk_rserver::signalk::{V1ACBus, V1Attr, V1CommonValueFields, V1Electrical, V1ElectricalACQualities, V1ElectricalIdentity, V1Environment, V1EnvironmentDepth, V1EnvironmentTime, V1FullFormat, V1Hello, V1Navigation, V1Notification, V1NotificationValue, V1NumberValue, V1PositionType, V1PositionValue, V1Propulsion, V1Source, V1SourceProperty, V1Sources, V1Vessel, V1Discovery, V1DiscoveryServer, V1DiscoveryEndpoint};
...
fn test_discovery() {
    ...
    let expected = V1Discovery::builder()
        .server(V1DiscoveryServer::new("signalk-server-node".into(), "0.1.33".into()))
        .endpoint("v1".into(), V1DiscoveryEndpoint::builder()
            .version("1.0.0".into())
            .signalk_http("http://localhost:3000/signalk/v1/api/".into())
            .signalk_ws("ws://localhost:3000/signalk/v1/stream".into())
            .build())
        .endpoint("v3".into(), V1DiscoveryEndpoint::builder()
