...
fn test_sample_docs_full_example() {
    let expected = V1RootFormat::builder()
        ...
        .sources(V1Sources::builder()
            .add_field("ttyUSB0".into(), V1Source::builder()
                .label("ttyUSB0".into())
                .type_("NMEA0183".into())
                .add_property("II".into(), V1SourceProperty::builder()
                    .talker("II".into())
                    .add_sentence("HDM".into(), "2017-05-16T05:15:54.006Z".into())
                    .build())
                .add_property("GP".into(), V1SourceProperty::builder()
                    .talker("GP".into())
